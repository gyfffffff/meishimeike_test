...
function parseItem(body, url){
    ...
    try{
        ...
        //     }
        // })
        fetchAddSql_Params = [shop_name, score, leixing, renjun, dizhi, yingyeshijian, kouwei, huanjing, fuwu, JSON.stringify(tuijiancai), JSON.stringify(user_comments), JSON.stringify(pics)]
