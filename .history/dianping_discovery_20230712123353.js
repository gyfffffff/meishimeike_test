...
function parseItem(body, url){
    ...
    var fetchAddSql = "INSERT INTO dianping_discovery(_url,url_shop,shop_name,score,leixing,renjun,dizhi,pics,_text,hot_comments,_time,fensi,crawltime) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";  // 13个字段,13?
    ...
    try{
        ...
        _time = body.match(/<div class="oublish-time">(\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2})<\/div>/g)[1]
