...
function parseItem(body, url){
    ...
    var fetchAddSql = "INSERT INTO dianping_discovery(_url, url_shop, shop_name, score, leixing, renjun, dizhi, pics, _text, hot_comments, _time, fensi, crawltime) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?.?)"  // 13
