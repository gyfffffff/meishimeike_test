...
function parseShop(body, url){
    ...
    var uscomments = {}  // score : text
    var pics = new Array()  // 32 img url, from comments

    var fetchAddSql = "INSERT INTO dianping(shop_name, score, leixing, renjun, dizhi, qu, dianhua, yingyeshijian, kouwei, huanjing, fuwu, tuijiancai, comments, pics) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)"
    ...
    try{
        ...
        fetchAddSql_Params = [shop_name, score, leixing, renjun, dizhi, qu, dianhua, yingyeshijian, kouwei, huanjing, fuwu, JSON.stringify(tuijiancai), JSON.stringify(comments), JSON.stringify(pics)]
