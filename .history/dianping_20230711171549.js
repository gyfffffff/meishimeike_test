...
function parseShop(body, url){
    ...
    try{
        ...
        fetchAddSql_Params = [shop_name, score, leixing, renjun, dizhi, qu, dianhua, yingyeshijian, kouwei, huanjing, fuwu, JSON.stringify(tuijiancai), JSON.stringify(comments, pics]
