...
function parseItem(body, url){
    ...
    var fetchAddSql = "INSERT INTO dianping(shop_name, score, leixing, renjun, dizhi, dianhua, yingyeshijian, kouwei, huanjing, fuwu, tuijiancai, user_comments, pics) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)"
    ...
    try{
        ...
        dizhi = $("#address").text().split("|")[1].trim()
        ...
        //     }
        // })
        fetchAddSql_Params = [shop_name, score, leixing, renjun, dizhi, dianhua, yingyeshijian, kouwei, huanjing, fuwu, JSON.stringify(tuijiancai), JSON.stringify(user_comments), JSON.stringify(pics)]
