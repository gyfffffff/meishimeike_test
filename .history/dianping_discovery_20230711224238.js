...
function parseItem(body, url){
    ...
    var fetchAddSql = "INSERT INTO dianping(shop_name, score, leixing, renjun, dizhi, pics, text) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)"
    ...
    try{
        ...
        $("thumbnail-list").each((index, elememt) => {
        ...
        fetchAddSql_Params = [shop_name, score, leixing, renjun, dizhi, JSON.stringify(pics), text]
