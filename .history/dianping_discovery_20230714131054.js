...
function parseItem(body, url){
    ...
    var fetchAddSql = "INSERT INTO dianping_discovery(_url,url_shop,shop_name,score,leixing,renjun,dizhi,pics,_text,_time,fensi,author_dizhi,crawltime,laiyuan) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";  // 13个字段,13?
