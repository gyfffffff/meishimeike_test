...
function myRequest(url, str){
    ...
    mysql.query(fetch_url_sql, fetch_url_sql_param, (qerr, vals, ))
    var options = {
        url: url,
        headers: headers,
...
function parseItem(body, url){
    ...
    var fetchAddSql = "INSERT INTO dianping(shop_name, score, leixing, renjun, dizhi, pics, text, time, fensi, crawltime) VALUES(?,?,?,?,?,?,?,?,?,?)"
    ...
    try{
        ...
        fetchAddSql_Params = [shop_name, score, leixing, renjun, dizhi, pics.join(", "), text, time, fensi, crawltime]
